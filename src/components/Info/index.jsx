...
//         <div className="sm:p-10 p-5 bg-white md:absolute z-50 w-[100%] md:left-0 md:right-0   md:-translate-y-[50%] shadow-gray-300 shadow-md ">
...
//           {/* scroll nav */}
//           <Navbar2 className="absolute left-0 bottom-0" />
//         </div>
//       </div>
//     </div>
//   );
